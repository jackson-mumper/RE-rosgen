...
CrossProf <- read.csv("../../data/derived/public/crossprofjackson.txt", header=FALSE, sep = " ", col.names=c("Junk","Distance","Elevation"))[c(2,3)]
LongProf <- read.csv("../../data/derived/public/longprofjackson.txt", header=FALSE, sep = " ", col.names=c("Junk","Distance","Elevation"))[c(2,3)]
```
...
DpthBf_Max <- 0.7728 # Insert the maximum bankfull depth from your point/reach of interest here, replacing the 8 left of the hash #
...
ggplot(CrossProf) +
       ...
       xlim(220,280) + # Sets the x-axis limits. Adjust this value as you zoom in to the correct area.
       ylim(1420,1425) + # Sets the y-axis limits. Adjust this value as you zoom in to the correct area.
       scale_color_gradient(low = "green", high = "brown") +
